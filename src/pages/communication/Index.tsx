...
const CommunicationIndex = () => {
  ...
  const features = [
    {
      icon: Radio,
      title: "Soluções de Comunicação",
      description: "Tecnologias avançadas para comunicação empresarial com alta qualidade e confiabilidade comprovada.",
    },
    {
      icon: Shield,
      title: "Segurança em Comunicação",
      description: "Proteção completa para suas comunicações com criptografia e monitoramento em tempo real.",
    },
    {
      icon: Headphones,
      title: "Suporte Técnico",
      description: "Equipe especializada 24/7 para configuração, manutenção e otimização de seus sistemas de comunicação.",
    },
    {
      icon: GraduationCap,
      title: "Treinamentos Profissionais",
      description: "Capacitação completa em tecnologias Zyxel e gestão de infraestrutura de comunicação.",
    },
  ];
          ...
          <div className="mx-auto max-w-4xl text-center animate-fade-in">
            ...
            <h1 className="mb-6 text-4xl font-bold tracking-tight md:text-6xl lg:text-7xl">
              ...
              <span className="bg-tech-gradient bg-clip-text text-transparent">
                Zyxel Brasil Communication
              </span>
            </h1>
            
            <p className="mb-8 text-lg text-muted-foreground md:text-xl lg:text-2xl">
              Conectando pessoas e empresas através de soluções inovadoras em comunicação e conectividade. 
              Com tecnologia de ponta e compromisso com a excelência, transformamos a forma como você se comunica.
            </p>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="mb-6 text-3xl font-bold md:text-4xl">Sobre a Zyxel Communication</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Parte do grupo Zyxel Communications desde 1989, somos especialistas em soluções de comunicação e conectividade. 
              Com presença global em mais de 150 países, oferecemos produtos inovadores que conectam pessoas e empresas. 
              No Brasil, combinamos tecnologia internacional de ponta com suporte local especializado, 
              garantindo comunicação eficiente e confiável para empresas de todos os tamanhos.
            </p>
          </div>
        </div>
      </section>
          ...
          <Card className="border-2 border-primary/20 bg-card/50 backdrop-blur">
            <CardHeader className="text-center pb-8">
              <CardTitle className="text-3xl md:text-4xl mb-4">
                Pronto para transformar sua comunicação empresarial?
              </CardTitle>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold">Zyxel Brasil Communication</span>
            </div>
            <p className="text-sm text-muted-foreground">
              © 2025 Zyxel Brasil Communication. Todos os direitos reservados.
            </p>
